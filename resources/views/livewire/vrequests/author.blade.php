<div class="flex md:flex-row flex-col antialiased text-gray-800 gap-2">
        ...
        <div class="py-4 pl-6 pr-6 w-50 bg-gray-100 dark:bg-gray-700 flex-shrink-0 rounded-2xl w-full ">
            ...
            <div class="flex flex-col mt-4 w-full px-4 rounded-lg">
                ...
                <div class="flex gap-2">
                    ...
                    <div class="text-sm mt-2 dark:text-gray-200 block">
                        <div class="font-semibold">
                            {{ $vrequest->staff->user->name }}

                        </div>
                        <div>
                            {{ $vrequest->staff->user->position }}

                        </div>
                        <div>
                            {{ $vrequest->staff->user->company_name }}
                ...
                <h2 class="mt-3 font-bold text-black dark:text-gray-300">Annual Leave Application Details</h3>
                    ...
                    <div class="flex text-sm text-black dark:text-gray-300 mt-2 gap-4">
                        ...
                        </span>{{ $vrequest->days . ' day(s)' }}


                    </div>

                    <div class="flex text-sm text-black dark:text-gray-300 mt-2">
                        ...
                        </span>From: {{ date('d-M-Y', strtotime($vrequest->date_start)) }}


                    </div>

                    <div class="flex text-sm text-black dark:text-gray-300 mt-1 mb-3">
                        ...
                        </span>To: {{ date('d-M-Y', strtotime($vrequest->date_end)) }}


                    </div>

                    <div class="flex text-sm font-semibold text-black dark:text-gray-300 mt-1 mb-5">
                    ...
                    <h3 class="mt-3 text-black dark:text-gray-300">Contact Information</h3>

                    <div class="flex mt-2 text-black dark:text-gray-300 text-sm mt-3 mb-2">
                        <svg class="w-6 h-6 mr-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex text-black dark:text-gray-300 text-sm mb-2"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="flex text-black dark:text-gray-300 text-sm mb-4"> <svg
                    ...
                    <div class="flex flex-col mt-2 w-full rounded-lg">
                        ...
                        <h3 class="mt-3 text-black dark:text-gray-300">For Human Resource Official Use</h3>
                        ...
                        <div class="flex text-sm text-black dark:text-gray-300 mt-2  mb-2 gap-4">
    ...
    <div class="md:w-2/5 overflow-x-hidden min-h-200 sm:w-full mt-3">
        ...
        <div class="py-4 pl-6 pr-6 w-50 bg-gray-100 dark:bg-gray-700 flex-shrink-0 rounded-2xl w-full ">
            ...
            <h3 class="mt-3 text-black dark:text-gray-300">For completion by Manager/ Head of Unit/ CARDI
                Representative</h3>
            ...
            <div class="text-sm text-black dark:text-gray-300 mt-2 gap-4 text-sm">
                <span>
                    <p class="mt-3 font-medium text-black dark:text-gray-300">
                        <span
            ...
            <ol class="relative border-l border-gray-500 dark:border-gray-200 mt-6">
                ...
                <li class="mb-10 ml-4 ">
                    ...
                    <time class="mb-1 text-sm font-normal leading-none text-gray-800 dark:text-gray-300">{{ $status->updated_at}}</time>
                    <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-200">{{ $status->notes}}
                    </p>
                </li>
                @endforeach
