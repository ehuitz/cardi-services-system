...
>
    ...
    <x-slot name="scripts">
        ...
        function createItem() {
            ...
            Livewire.emit('createUser', name, email, password, password2, country);
        }
        ...
        function updateItem() {
            ...
            Livewire.emit('updateUser', id, name, email, country);
        }
        ...
        function updateModal(id) {
            var countries = $('tr[id='+id+']').find('td:nth-child(2)').text().trim();
            ...
            Array.from(document.querySelector("#edit_country").options).forEach(function(option) {
