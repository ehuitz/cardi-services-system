<div class="py-4 pl-6 pr-6 w-50 bg-gray-100 dark:bg-gray-700 flex-shrink-0 rounded-2xl w-full ">
    ...
    <div class="flex flex-col mt-4 w-full px-4 rounded-lg">
        ...
        <div class="flex text-black dark:text-gray-300 text-sm"> <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-5"
                    ...
                    <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                        <ul role="list" class="border border-gray-200 rounded-md divide-y divide-gray-200">
                            @if (count($contracts))
                                @foreach ($contracts as $contract)
                                    <li class="pl-3 pr-4 py-3 flex items-center justify-between text-xs">
                                        <div class="w-0 flex-1 flex items-center">
                                            ...
                                            <span class="ml-2 flex-1 w-0 truncate">{{ $contract['name'] }} </span>
                                        </div>
                                        <div class="ml-4 flex-shrink-0">
                                ...
                                @endforeach
                            @else
                                <li class="pl-3 pr-4 py-3 flex items-center justify-between text-xs">No contracts files
                                    available</li>
                            @endif
                        </ul>
                    </dd>
...
<h2 class="text-gray-800 dark:text-gray-200 mt-5 text-center">Upload a File</h2>
        <div class="col-span-6 sm:col-span-3">
                ...
                <select id="type" name="type" autocomplete="type-name" class="mb-2 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm dark:bg-gray-800 dark:text-gray-200 sm:text-sm">
