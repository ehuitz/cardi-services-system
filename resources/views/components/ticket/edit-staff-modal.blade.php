<div x-data="{ open: false }">
    ...
    <div class="fixed z-50 inset-0 overflow-y-auto m-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true"
        x-show="open">
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white dark:bg-gray-700 rounded-lg text-left
                ...
                @click.away="open = false" @close.stop="open = false" x-on:keydown.escape="open = false"
                    ...
                    <div class="sm:flex sm:items-start">
                        <div
                            class="mx-auto flex-shrink-0 flex items-center
                                justify-center h-12 w-12 rounded-full bg-blue-100 dark:bg-blue-200
                                sm:mx-0 sm:h-10 sm:w-10 text-blue-500 dark:text-blue-600">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="mt-2 w-full">
                                <x-forms.staff-select id="staff" :items="$staff" :val="request()->ticket->staff" />
                            </div>
...
<script>
    function updateStaff() {
        if ($('#staff').val() == '') {
            Swal.fire({
                title: 'Error!',
                text: 'Assign to atleast one staff member',
                icon: 'error',
            ...
            $.ajax({
                type: 'POST',
                url: '{{ route("tickets.update.staff") }}',
                data: {
