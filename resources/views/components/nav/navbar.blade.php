<div class="flex flex-col flex-1 w-full">
    <header class="z-10 py-4 bg-green-500 shadow-md dark:bg-gray-800">
        <div
                ...
                <li class="relative">
                    <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none"
                        ...
                        <img class="object-cover w-8 h-8 rounded-full"
                            src="{{ asset(auth()->user()->path) }}" alt="" aria-hidden="true" />
                    </button>
                    ...
                    <ul class="absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600
                        ...
                        <a href="{{ route('profile') }}" class="font-medium text-indigo-600 hover:text-indigo-500"> Download </a>
