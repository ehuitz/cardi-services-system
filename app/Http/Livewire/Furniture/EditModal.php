...
class EditModal extends Modal
{
	...
	protected $listeners = [
		...
		'editFurnitureErrorBag' => 'editFurnitureErrorBag'
	];
	...
	public function editFurnitureErrorBag($errorBag) {
		$this->setErrorBag($errorBag);
	}

    public function render()
    {
        return view('livewire.furniture.edit-modal');
    }
}
